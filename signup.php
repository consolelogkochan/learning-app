        ...
        <div class="auth-card">
            ...
            <form action="signup_process.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="nickname" name="nickname" placeholder="学習 太郎" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="invite_code" name="invite_code" placeholder="管理者から伝えられたコード" required>
                </div>
